import{importShared as S}from"./__federation_fn_import-CH-LSGom.js";import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{F as g}from"./FormInput-Be8HZb1z.js";await S("react");const{useForm:x,FormProvider:v}=await S("react-hook-form"),{Box:B,Button:y,useTheme:T}=await S("@mui/material"),w={title:"SharedComponents/FormInput",component:g,tags:["autodocs"],parameters:{docs:{description:{component:`
### 🧾 FormInput

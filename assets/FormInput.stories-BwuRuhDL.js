import{importShared as h}from"./__federation_fn_import-DU6Trtru.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{F as S}from"./FormInput-C9gyacQI.js";await h("react");const{useForm:x,FormProvider:F}=await h("react-hook-form"),{Box:B,Button:I,useTheme:v}=await h("@mui/material"),V={title:"SharedComponents/FormInput",component:S,tags:["autodocs"],parameters:{docs:{description:{component:`
### 🧾 FormInput
